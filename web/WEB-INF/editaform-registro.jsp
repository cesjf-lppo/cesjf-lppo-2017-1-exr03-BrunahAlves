...
<html>
    ...
    <body>
        ...
        <form method="post">
            ...
            <div><label>Entrada: <input type="text" name="idade" value="${visitante.entrada}"</label></div>
            <div><label>Saida: <input type="text" name="idade" value="${visitante.saida}"</label></div>

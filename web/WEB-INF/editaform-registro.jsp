...
<html>
    ...
    <body>
        ...
        <form method="post">
            ...
            <div><label>Entrada: <input type="datetime-local" name="entrada" value="${visitante.entrada}"/></label></div>
            <div><label>Saida: <input type="datetime-local" name="saida" value="${visitante.saida}"/></label></div>
